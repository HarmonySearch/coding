...
def main():
    ...
    for i in range(0,50,1): # до 50
        ...
        url = "https://togliatti.hh.ru/search/vacancy?L_is_autosearch=false&area=212&clusters=true&enable_snippets=true&page={0}".format(i)
        # print(url)
        driver.get(url)
        sleep(2)
    ...
    file_xlsx = os.getenv('HOME') + '\\Documents\\hh_tlt.xlsx'
    wb.save(file_xlsx)
